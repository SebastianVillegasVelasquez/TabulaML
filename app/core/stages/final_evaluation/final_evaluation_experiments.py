...
def get_final_evaluation_experiments(context: Context) -> list[ExperimentDefinition]:
...
def _get_models(context: Context):
    from app.core.stages.threshold_optimizer import ThresholdOptimizer

    is_classification = context.config.problem_type == ProblemType.CLASSIFICATION
